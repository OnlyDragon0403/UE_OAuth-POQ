...
namespace UnrealHttp
{
    namespace api
    {
        ...
        struct QAUTHPOQ_API HttpRetryManager : public FManager, public FTickerObjectBase {
            using FManager::FManager;

            bool Tick(float DeltaTime) final;
        };

        struct QAUTHPOQ_API HttpRetryParams {
            HttpRetryParams(
